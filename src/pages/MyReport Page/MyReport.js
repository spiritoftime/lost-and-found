    ...
    {values.userReports && values.userReports.map((report,index)=>{        
        ...
        <div className="p-5">
           <div  className="mb-5">
            ...
            <button onClick={()=>editReport(report)} className="mr-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            <Link to={report.reportType ==="missing"? "/missing" : "spotted"}  >
               <span className='mr-2'>Edit</span>
               {editIcon}
            </Link>
            </button>
            <Link href="#" className="mr-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
