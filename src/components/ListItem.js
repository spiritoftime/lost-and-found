...
const ListItem = ({ report }) => {
  ...
  return (
    <div className="w-fit grid grid-cols-6 bg-white   rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      >
        <text className="xs:text-xs md:text-xl font-extrabold">
          {report.reportType}
        </text>
      </div>
    </div>
